...
.onLoad <- function(libname, pkgname) {
	...
	libpath = find.package("html2pdfr")
	
	# files get moved during  
	jarLoc = paste0(libpath,"/java/html2pdfr-0.0.3-SNAPSHOT-jar-with-dependencies.jar")
	
	if (!file.exists(jarLoc)) {
		
		jarLoc = paste0(libpath,"/inst/java/html2pdfr-0.0.3-SNAPSHOT-jar-with-dependencies.jar")
		...
		if (!file.exists(jarLoc)) {
			...
			fs::file_copy(jarLoc, paste0(libpath,"/java/html2pdfr-0.0.3-SNAPSHOT-jar-with-dependencies.jar"))
		}
	}
